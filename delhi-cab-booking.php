                                ...
                                <div class="caption">
    							   ...
    							   ?>
                                    <h4 class="caption-title">
                                        <a href="#"><?php echo $result['vehicle_name'];?></a>
                                    </h4>
    							   ...
    							   <div class="col-md-6 col-sm-6 col-xs-6" style="margin-top:-14px;margin-left:-14px"><strong>Billable Total Distance:</strong>
    							   <br />
    							   ...
    							   <div class="col-md-6 col-sm-6 col-xs-6"  style="margin-top:-14px;margin-left:-34px;width:60%;margin-bottom:-15px">
    							    ...
    							    <?php echo $finaldistance." Km ( For ".$triptype." )";?> <br />
    								 ...
    								 Rs.(<?php echo $distancecharge;?> + <?php echo $drivercharge;?>) = Rs. <?php echo number_format($finalTotalAmount);?><br />
                                     <p style="font-size:13px;color:#cc0000">(<b>Tolls,Parking and State Permits as per actuals.</b>)</p>
    							   </div>
                                    ...
                                    <div class="form-search light">
                                        <form action="delhi-cab-booking.php" method="post">
    										...
    										<div class="form-group selectpicker-wrapper">
                                                <label>Select Trip Type</label><br />
                        ...
                        <div class="row">
                            <div class="col-md-9 content car-listing" id="content">
                                <?php 
                                    ...
                                    $cars = "SELECT * FROM trips WHERE trip_from='$piclocation' AND trip_end='$droplocation' AND triptype_name='$triptype' AND triptype_name='$triptype'";
                                    //echo $cars;
                                    $runtrips = mysqli_query($admin_con, $cars);
                                    $checkData = mysqli_num_rows($runtrips);
                                    ...
                                    if($checkData > 0){ 
                                    // GET TRIP RECORD IF RESULT FOUND //
                                        while($record = mysqli_fetch_array($runtrips,MYSQLI_ASSOC)){
                                      
                                        //$vehicle_id=$record['vehicle_id'];
                                        $trip_price = $record['trip_price'];
                                        
                                        $vehicle_id=explode(', ', $record['vehicle_id']);
                                        $count=count($vehicle_id);

                                        for($i=0; $i<$count;$i++){
                                            $vehicle=$vehicle_id[$i];
                                            $all_cats= "SELECT * FROM vehicles WHERE vehicle_id='$vehicle'";
                                ...
                                <div class="thumbnail no-border no-padding thumbnail-car-card clearfix">
                                    <div class="media">
                                        <a class="media-link" data-gal="prettyPhoto" href="delhicab-admin/img/vehicles/<?php $img=explode(',', $result['vehicle_images']);echo $img[0];?>">
                                            <img class="img-responsive" style="border-right: 1px solid #dedede;width: 375px; height:195px" src="delhicab-admin/img/vehicles/<?php echo $img[0];?>" alt=""/>
                                        </a>
                                    </div>
                                    <div class="caption">
                                        <h4 class="caption-title">
                                        ...
                                        <div class="caption-text">
                                            <div class="col-md-6 col-sm-6 col-xs-6" style="margin-top:0px;margin-left:-14px">
                                                <strong>Total Price:</strong><br />
                                                <strong>From:</strong><br />
                                                <strong>Picking Up date:</strong>
                                            </div>
                                            <div class="col-md-6 col-sm-6 col-xs-6"  style="margin-top:0px;margin-left:-34px;width:60%;margin-bottom:-15px">
                                                Rs. <?php echo $trip_price; ?><br />
                                                <?php echo $piclocation; ?> to <?php echo $droplocation;?>(<?php echo $triptype;?>)<br />
                                                <?php echo date('jS M Y',strtotime($_POST['picdate']));?><br />
                                            </div>
                                        ...
                                        <table class="table">
                                            <tr>
                                                ...
                                                <form action="booking.php" method="post">
                                                <input type="hidden" name="triptype"  value="<?php echo $triptype; ?>" />
                                                <input type="hidden" name="total" value="<?php echo $trip_price;?>"/>
                                                <input type="hidden" name="picdate" value="<?php echo $_POST['picdate'];?>"/>
                                                <input type="hidden" name="from" value="<?php echo $piclocation;?>"/>
                                                <input type="hidden" name="to" value="<?php echo $droplocation;?>" />
                                                <input type="hidden" name="vehiclename" value="<?php echo $result['vehicle_name'];?>" />
