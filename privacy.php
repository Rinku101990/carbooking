...
<head>
    ...
    <title>Delhi Cab booking Services | Privacy and Policies</title>
...
<div class="wrapper">
    ...
    <div class="content-area">
        ...
        <!-- BREADCRUMBS -->
        <section class="page-section breadcrumbs" style="background-image: url(assets/img/Background.png);">
            <div class="container text-right">
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li><a href="#">Delhi Cab booking Services	</a></li>
                        ...
                        <article class="post-wrap post-single">
                            <div class="post-body">
                                <div class="post-excerpt">
                                    <p class="text-xl">Privacy and Policy</p>
