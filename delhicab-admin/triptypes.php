...
<head>
    ...
    <title>Delhi Car Booking | Trip Types</title>
                ...
                <div class="row gutter">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="panel panel-yellow">
							...
							<?php if(isset($_GET['msg'])) { ?><p style="color: green; font-weight:600"><i class="fa fa-thumbs-up"></i> Trip Category has been added.</p><?php } ?>
                                <form method="post" action="inserttriptype.php" class="form-horizontal">
                                    <fieldset>
                                        <legend>Enter Trip Category</legend>
                                        <div class="form-group">
                                            <label class="col-lg-4 control-label">Trip Type</label>
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" name="triptype">
                                            </div>
                                        </div>
                                    ...
                                    <table id="basicExample" class="table table-striped table-condensed table-bordered no-margin">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="delete-triptype.php?delete=<?php echo $result['triptype_id']?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> </a>
