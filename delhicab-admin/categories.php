...
<body class="pink">
    <div class="vertical-nav">
        <div class="logo">
            <h2><a href="http://avfashiongroup.in/av-admin" style="color:white">AV Fashion Group</a></h2>
        </div>
        <div class="user-info">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <h4>Add Category Name</h4></div>
                            <div class="panel-body">
                                <form method="post" action="insertcategory.php" class="form-horizontal bv-form">
                                    <fieldset>
                                        <div class="form-group has-feedback">
                                            <label class="col-lg-3 control-label">Category Name</label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="category" placeholder="Category Name" required></div>
												<div class="col-lg-3 ">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table id="example" class="table table-striped table-condensed table-bordered no-margin file-export">
                                        ...
                                        <tbody>
										<?php $all_cats= "SELECT * from categories";
								...
								?>
                                            <tr>
                                                <td><?php echo $i; ?>.</td>
                                                <td><?php echo $result['av_cat']?></td>
                                                <td><a href="delete-category.php?av_catid=<?php echo $result['av_catid']?>" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a></td>
                                            </tr>
								 <?php $i++;} ?>
                                        </tbody>
                                    </table>
