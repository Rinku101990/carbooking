...
<head>
    ...
    <title>Delhi cab Booking Services | About Us</title>
        ...
        <section class="page-section color">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
					<h3>Who we are</h3>
                        <p>Comparing & booking minicab & taxi quotes online will save you time and effort vs. if you dial local taxi numbers to gather cab fares on the telephone. We provide all kind of tour and travel taxi services. </p>
                    </div>
                    <div class="col-md-4">
					<h3>What we do</h3>
                        <p>Dalihicarbooking calculates fares from different kind of cab facilities across India, enabling you to compare real-time online taxi quotes pre-set by the our company ourselves.</p>
                    </div>
                    <div class="col-md-4">
					<h3>Why choose us</h3>
                        <p>Delhicarbooking provide instant car delivery on time. We fullfil all kind of requirements according to your need. We having best trained drivers and neet & clean vehicles available 24 *7 Hrs.</p>
                    </div>
                </div>
